...
public class ExplorePaginationController {
  ...
  private ExploreViewController controller;
  ...
  public void setPagination() {
    ...
    int currentPage = (int) controller.getSearchParams().get(GameSearchParams.PAGE_NUMBER);
   ...
   */
  public void setSearchController(ExploreViewController controller) {
  ...
  private Label generatePageNumber(int pageNumber, boolean isCurrentPage) {
    ...
    if (!isCurrentPage) {
      ...
      pageLabel.setOnMouseClicked(event -> {
        controller.getSearchParams().put(GameSearchParams.PAGE_NUMBER, pageNumber);
